 ...
 * @since gofresh 1.0
 */
function gofresh_theme_support() {
	...
	add_image_size( 'gofresh-fullscreen', 1980, 9999 );
	 ...
	 * If you're building a theme based on gofresh, use a find and replace
	 * to change 'gofresh' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'gofresh' );
	...
	if ( is_customize_preview() ) {
		...
		add_theme_support( 'starter-content', gofresh_get_starter_content() );
	}
	 ...
	 * by the theme.
	 */
	$loader = new gofresh_Script_Loader();
	add_filter( 'script_loader_tag', array( $loader, 'filter_script_loader_tag' ), 10, 2 );

}

add_action( 'after_setup_theme', 'gofresh_theme_support' );
...
// Handle SVG icons.
require get_template_directory() . '/classes/class-gofresh-svg-icons.php';
require get_template_directory() . '/inc/svg-icons.php';

// Handle Customizer settings.
require get_template_directory() . '/classes/class-gofresh-customize.php';

// Require Separator Control class.
require get_template_directory() . '/classes/class-gofresh-separator-control.php';

// Custom comment walker.
require get_template_directory() . '/classes/class-gofresh-walker-comment.php';

// Custom page walker.
require get_template_directory() . '/classes/class-gofresh-walker-page.php';

// Custom script loader class.
require get_template_directory() . '/classes/class-gofresh-script-loader.php';

// Non-latin language handling.
require get_template_directory() . '/classes/class-gofresh-non-latin-languages.php';
 ...
 */
function gofresh_skip_link_focus_fix() {
...
add_action( 'wp_print_footer_scripts', 'gofresh_skip_link_focus_fix' );
 ...
 * @return string
 */
function gofresh_get_custom_logo( $html ) {
...
add_filter( 'get_custom_logo', 'gofresh_get_custom_logo' );
 ...
 */
function gofresh_get_color_for_area( $area = 'content', $context = 'text' ) {
 ...
 * @return array
 */
function gofresh_get_elements_array() {
	...
	/**
	 * Filters gofresh theme elements.
	 *
	 * @since gofresh 1.0
	 *
	 * @param array Array of elements.
	 */
	return apply_filters( 'gofresh_get_elements_array', $elements );
}
