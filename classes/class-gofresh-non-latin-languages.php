...
if ( ! class_exists( 'gofresh_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 *
	 * @since gofresh 1.0
	 */
	class gofresh_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'gofresh_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'gofresh_get_localized_font_family_elements',
				array(
			...
			return gofresh_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
